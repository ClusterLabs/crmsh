...
Disable the cluster-related system services on all nodes or a specific node.
...
Enable the cluster-related system services on all nodes or a specific node.
...
Starts the cluster-related system services on all nodes or a specific node.
...
Stops the cluster-related system services on all nodes or a specific node.
