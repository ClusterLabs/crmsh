...
[[cmdhelp_script_describe,Describe the script]]
==== `describe`
...
of steps that will be executed when running the script
...
Example:
............
verify init nodes="node-1 node-2 node-3"
............

[[cmdhelp_script_run,Run the script]]
==== `run`

Runs a script. Can optionally take at least two arguments:
...
Use the `describe` command to see what parameters are available.
