...
'''.encode('utf-8'),
    ...
    def test_sync_file_peer(self, mock_fetch_nodes, mock_cluster_copy):
        mock_fetch_nodes.return_value = ["node1", "node2"]
        bootstrap.sync_file("/file1", peer_node="node3")
        mock_fetch_nodes.assert_called_once_with("node3")
        mock_cluster_copy.assert_called_once_with("/file1", nodes=["node1", "node2"], output=False)
