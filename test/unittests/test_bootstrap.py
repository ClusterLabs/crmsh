...
class TestValidation(unittest.TestCase):
    ...
    def test_get_cluster_node_ips_fallback(self, mock_get_iplist, mock_get_remote_stdout):
    ...
    @mock.patch('crmsh.utils.get_stdout_stderr_auto_ssh_no_input')
    @mock.patch('crmsh.utils.get_iplist_from_name')
    def test_get_cluster_node_ips_success(self, mock_get_iplist, mock_get_remote_stdout):
    ...
    def test_remove_node_from_cluster_rm_node_failed(self, mock_get_nodeid, mock_stop, mock_status, mock_invoke, mock_error, mock_rm_conf_files, mock_call_delnode):
    ...
    @mock.patch('crmsh.bootstrap.stop_services')
    @mock.patch('crmsh.utils.get_nodeid_from_name')
    def test_remove_node_from_cluster_rm_csync_failed(self, mock_get_nodeid, mock_stop, mock_status, mock_invoke, mock_invokerc, mock_error, mock_rm_conf_files, mock_call_delnode):
        mock_get_nodeid.return_value = '1'
