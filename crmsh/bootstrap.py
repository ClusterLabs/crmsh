...
def retrieve_files(from_node: str, file_list: list = None, msg: str = None):
    if not file_list:
        file_list = [f for f in get_files_to_sync() if f != CSYNC2_KEY and f != CSYNC2_CFG]
