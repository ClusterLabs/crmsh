...
class CibConfig(command.UI):
    ...
    def do_verify(self, context):
        ...
        return verify_result <= constants.VERIFY_WARNING
    ...
    def _commit(self, force=False, replace=False):
        ...
        if verify_result >= constants.VERIFY_FATAL_ERROR:
            return False

        if rc1 and verify_result <= constants.VERIFY_WARNING:
