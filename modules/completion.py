...
from utils import listtemplates, listconfigs
...
def get_completer_list(lvl_obj, cmd):
    ...
    try:
        return completer_lists[lvl_obj.lvl_name][cmd]
    except:
        try:
            return completer_lists[lvl_obj.lvl_name][lvl_obj.rev_alias_table[cmd]]
        except:
            return None
